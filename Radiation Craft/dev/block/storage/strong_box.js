/*
var BLOCK_TYPE_STRONG_BOX = Block.createSpecialType({
	base: 1,
	solid: true,
	destroytime: 5,
	explosionres: 6000,
...
IDRegistry.genBlockID("strongBox"); 
Block.createBlockWithRotation("strongBox", [
	{name: "Strong Box", texture: [["strong_box_bottom", 0], ["strong_box_top",0], ["strong_box_side", 0], ["strong_box_front", 0], ["strong_box_side", 0], ["strong_box_side", 0]], inCreative: true}
], BLOCK_TYPE_STRONG_BOX);

ToolAPI.registerBlockMaterial(BlockID.reinforcedGlass, "stone", 2, true);


var gui_strongbox = new UI.StandartWindow({
standart: {
header: { text: { text: "Сейф" }},
...
elements: {
	...
	"produce39": {type: "slot", x: 430, y: 290, size: 60},
	"produce40": {type: "slot", x: 490, y: 290, size: 60},
	"produce41": {type: "slot", x: 550, y: 290, size: 60},
	"produce42": {type: "slot", x: 610, y: 290, size: 60},
	"produce43": {type: "slot", x: 670, y: 290, size: 60},
	"produce44": {type: "slot", x: 730, y: 290, size: 60},
	"produce45": {type: "slot", x: 790, y: 290, size: 60},
	"produce46": {type: "slot", x: 850, y: 290, size: 60},
	"produce47": {type: "slot", x: 370, y: 350, size: 60},
	"produce48": {type: "slot", x: 430, y: 350, size: 60},
	"produce49": {type: "slot", x: 490, y: 350, size: 60},
	"produce50": {type: "slot", x: 550, y: 350, size: 60},
	"produce51": {type: "slot", x: 610, y: 350, size: 60},
	"produce52": {type: "slot", x: 670, y: 350, size: 60},
	"produce53": {type: "slot", x: 730, y: 350, size: 60},
	"produce54": {type: "slot", x: 790, y: 350, size: 60},
	"produce55": {type: "slot", x: 850, y: 350, size: 60}
}});

TileEntity.registerPrototype(BlockID.strongBox,{getGuiScreen:function(){return gui_strongbox}});*/