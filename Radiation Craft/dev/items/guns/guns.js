...
Item.createItem("ak74", "AKS74 - U", {name: "ak74", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.ak74);
Item.setMaxDamage(ItemID.ak74, 30);


Item.createItem("aug", "AUG", {name: "aug", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.aug);
Item.setMaxDamage(ItemID.aug, 42);


Item.createItem("bizon", "Bizon", {name: "bizon", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.bizon);
Item.setMaxDamage(ItemID.bizon, 32);


Item.createItem("deserteagle", "Desert Eagle", {name: "deserteagle", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.deserteagle);
Item.setMaxDamage(ItemID.deserteagle, 7);


Item.createItem("dragunov", "Dragunov", {name: "dragunov", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.dragunov);
Item.setMaxDamage(ItemID.dragunov, 10);


Item.createItem("fnscar", "FN SCAR", {name: "fnscar", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.fnscar);
Item.setMaxDamage(ItemID.fnscar, 30);


Item.createItem("glock", "Glock", {name: "glock", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.glock);
Item.setMaxDamage(ItemID.glock, 31);


Item.createItem("m16", "M16", {name: "m16", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.m16);
Item.setMaxDamage(ItemID.m16, 30);


Item.createItem("magnum", ".44 Magnum", {name: "44magnum", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.magnum);
Item.setMaxDamage(ItemID.magnum, 6);


Item.createItem("makarov", "Makarov", {name: "makarov", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.makarov);
Item.setMaxDamage(ItemID.makarov, 8);


Item.createItem("mp5", "MP5", {name: "mp5", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.mp5);
Item.setMaxDamage(ItemID.mp5, 40);


Item.createItem("rpd", "RPD", {name: "rpd", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.rpd);
Item.setMaxDamage(ItemID.rpd, 100);


Item.createItem("rpg", "RPG", {name: "rpg", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.rpg);
Item.setMaxDamage(ItemID.rpg, 1);


Item.createItem("rpk", "RPK", {name: "rpk", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.rpk);
Item.setMaxDamage(ItemID.rpk, 40);


Item.createItem("spas", "SPAS - 12", {name: "spas", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.spas);
Item.setMaxDamage(ItemID.spas, 8);


Item.createItem("usp", "USP", {name: "usp", data: 0},{stack: 1});
UIGUNs.gunButton(ItemID.usp);
Item.setMaxDamage(ItemID.usp, 12);
