	...
	OTO_RECIPE_PAGE: function (params, elements, container, section) {
		...
		if(params.recipes){
			for(let key in params.recipes){
				...
				elements["oto_bar_" + key + "_" + section] = {type: "image", x: xp + 70, y: yp + 10, bitmap: params.bar_texture || "furnace_bar_background", scale: 3.2};
	...
	GRID_3x3_PAGE: function (params, elements, container, section) {
		...
		if(params.recipes){
			for(let key in params.recipes){
				...
				elements["grid_3x3_bar_" + key + "_" + section] = {type: "image", x: xp + 195, y: yp + 65, bitmap: params.bar_texture || "furnace_bar_background", scale: 3.2};
